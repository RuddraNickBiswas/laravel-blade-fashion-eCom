		...
		<section id="content">
			<div class="content-wrap">
				<div class="container">
					...
					<table class="table cart mb-5">
                        ...
                        <tr class="cart_item">
                            <td class="cart-product-remove">
                                <a class=".delete-item" href="{{ route('cart.destroy', $cartProduct->rowId) }}" title="Remove this item"><i class="icon-trash2"></i></a>
                            </td>

                            <td class="cart-product-thumbnail">
                                <a href="#"><img width="64" height="64" src="{{ asset($cartProduct->options->product_info['thumbnail_path']) }}" alt="Pink Printed Dress"></a>
                            </td>
					...
					{{--This section will be creted later--}}
                            <td class="cart-product-quantity">
                                <div class="quantity">
                                    <input  disabled type="button" value="-" class="minus">
                                    <input disabled type="text" name="qty" value="{{ $cartProduct->qty }}" class="qty" />
					...
					<div class="row d-flex align-items-end justify-content-end col-mb-30">
						...
						<div class="col-lg-6">
							<a href="#" class="button button-desc ms-lg-4">
								<div> Checkout </div>
								<span>Free Forever, Enjoy Free Shipping</span></a>
						</div>
					</div>
