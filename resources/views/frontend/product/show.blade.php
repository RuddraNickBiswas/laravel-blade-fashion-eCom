                            ...
                            <div class="row gutter-40">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="product-image" style="overflow: visible;">
                                        <div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-lightbox="gallery" data-margin="0" data-items="1" data-pagi="false" data-autoplay="6000" data-loop="true">
                                            ...
                                            <div class="oc-item">
                                                <a href=" {{ asset($image->path) }} " title="Pink Printed Dress - Front View" data-lightbox="gallery-item"><img src="{{ asset($image->path) }}" alt="Pink Printed Dress"></a>
                                            </div>
                                            @endforeach
                                    ...
                                    <div id="linked-to-gallery" style="margin-top: 4px;">
                                        <div id="oc-images-linker" class="owl-carousel image-carousel carousel-widget" data-margin="4" data-items="4" data-pagi="false" data-loop="true">
                                            ...
                                            <div class="oc-item">
                                                <a href="#" data-image="{{ ++$key }}"><img src="{{ asset($image->path) }}" alt="Gallery Thumb  {{ ++$key }} "></a>
                                            </div>
                                ...
                                <div class="col-md-6 product-desc">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="product-price"><del>$ {{ $product->price }} </del> <ins> {{ $product->discounted_price }} </ins></div><!-- Product Single - Price End -->
                                            
                                        @else
                                        <div class="product-price"><del>$ {{ $product->price }} </del></div><!-- Product Single - Price End -->
                                        @endif
                                    ...
                                    <div class="card product-meta">
                                        <div class="card-body">
                                            ...
                                            <span class="tagged_as">Size:
                                                ...
                                                <a href="#" class="me-2" rel="tag"> {{ $size->name }} </a> 
                                                @endforeach
                                        </div>
                                                ...
                                                <div class="grid-inner row g-0">
                                                    <div class="col-auto">
                                                        <div class="entry-image">
                                                            <a href="#"><img src=" {{ asset($recentProduct->thumbnail_path) }} " alt="Image"></a>
                                                        </div>
                                                    </div>
                                                    <div class="col ps-3">
                                                        <div class="entry-title">
                                                            <h4><a href="#"> {{ $recentProduct->name }} </a></h4>
                                                        </div>
                                                        <div class="entry-meta no-separator">
                                                            <ul>
                                                                @if ($recentProduct->discounted_price)
                                                                <li><del class="me-1 color"> $ {{ $recentProduct->discounted_price }}  </del> <ins> ${{ $recentProduct->price }} </ins></li>
                                                                @else
                                                                <li class="color"><ins> $ {{ $recentProduct->price }} </ins> </li>
                                                                @endif
                                        ...
                                        <div class="posts-sm row col-mb-30" id="recent-shop-list-sidebar">
                                            ...
                                            <div class="entry col-12">
                                                <div class="grid-inner row g-0">
                                                    <div class="col-auto">
                                                        <div class="entry-image">
                                                            <a href="#"><img src=" {{ asset($randomProduct->thumbnail_path) }} " alt="Image"></a>
                                                        </div>
                                                    </div>
                                                    <div class="col ps-3">
                                                        <div class="entry-title">
                                                            <h4><a href="#"> {{ $randomProduct->name }} </a></h4>
                                                        </div>
                                                        <div class="entry-meta no-separator">
                                                            <ul>
                                                                @if ($randomProduct->discounted_price)
                                                                <li><del class="me-1 color"> $ {{ $randomProduct->discounted_price }}  </del> <ins> ${{ $randomProduct->price }} </ins></li>
                                                                @else
                                                                <li class="color"><ins> $ {{ $randomProduct->price }} </ins> </li>
                                                                @endif
                                                                <li><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star-half-full"></i></li>
                                                            </ul>
                                                        </div>
