...
<div id="oc-products" class="owl-carousel products-carousel carousel-widget" data-margin="20" data-loop="true" data-autoplay="5000" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-items-xl="5">
    ...
    <div class="oc-item">
        <div class="product">
            <div class="product-image">
                <a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/1.jpg')}}" alt="Round Neck T-shirts"></a>
                <a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/1-1.jpg')}}" alt="Round Neck T-shirts"></a>
                <div class="sale-flash badge bg-danger p-2">Sale!</div>
                <div class="bg-overlay">
                    <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                        <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                        <a href="{{asset('frontend/demos/shop/ajax/shop-item.html')}}" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                    </div>
    ...
    <div class="oc-item">
        <div class="product">
            <div class="product-image">
                <a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/2.jpg')}}" alt="Navy Blue Dress"></a>
                <a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/2-1.jpg')}}" alt="Navy Blue Dress"></a>
                <div class="bg-overlay">
                    <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                        <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                        <a href="{{asset('frontend/demos/shop/ajax/shop-item.html')}}" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
            ...
            <div class="product-image">
                ...
                <div class="bg-overlay">
                    <div class="bg-overlay-content align-items-end" data-hover-animate="fadeIn" data-hover-speed="400">
                        <a href="{{asset('frontend/demos/shop/ajax/shop-item-no-stock.html')}}" class="btn btn-dark" data-lightbox="ajax">Quick View</a>
                    </div>
                    <div class="bg-overlay-bg bg-transparent"></div>
                </div>
            </div>
                ...
                <div class="fslider" data-arrows="false" data-autoplay="4500">
                    <div class="flexslider">
                        <div class="slider-wrap">
                            <div class="slide"><a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/4.jpg')}}" alt="T-shirts"></a></div>
                            <div class="slide"><a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/4-1.jpg')}}" alt="T-shirts"></a></div>
                            <div class="slide"><a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/4-2.jpg')}}" alt="T-shirts"></a></div>
                            <div class="slide"><a href="#"><img src="{{asset('frontend/demos/shop/images/items/featured/4-3.jpg')}}" alt="T-shirts"></a></div>
                        </div>
                    </div>
                </div>
                <div class="bg-overlay">
